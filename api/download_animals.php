...
if ($_type === "csv") {
    $_data .=
        "id;Имя;Порода;Дата рождения;Короткое описание;Полное описание;Пол;Привит/а;Кастрирован/Стерилизована;Вид;Статус;Опубликован;Дата создания записи;Дата последнего обновления записи\n";
}
if ($_type === "html") {
...
while ($_row = $_result->fetch_array()) {
    ...
    if ($_type === "html") {
        ...
        $_data .=
            "<b>Привит/а</b>: " . convertGrafted($_row["grafted"]) . "<br/>";
        $_data .=
            "<b>Кастрирован/Стерилизована</b>: " .
            convertSterilized($_row["sterilized"]) .
            "<br/>";
