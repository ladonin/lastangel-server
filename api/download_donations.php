...
$_stmt = $db_mysqli->prepare(
    "SELECT * FROM donations order by id DESC LIMIT 5000"
);
$_stmt->execute();
...
if ($_type === "csv") {
    $_data .=
        "id;Имя;Отчество;Фамилия;Карточка/телефон;Сумма;Тип доната;Для кого/чего;Дата создания;Дата последнего обновления\n";
}
if ($_type === "html") {
