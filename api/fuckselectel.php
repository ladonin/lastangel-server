...
$_stmt = $db_mysqli->prepare("SELECT id, another_images, main_image, video1, video2, video3 from animals");
...
while($_row = $_result->fetch_array()){
	...
	if ($_row['video1']) {
			file_put_contents(
				...
				fopen("https://140706.selcdn.ru/lastangel/media/pets/".$_row['id']."/video1.mp4", 'r')
			);
	}
		if ($_row['video2']) {
			file_put_contents(
				"media/pets/".$_row['id']."/video2.mp4", 
				fopen("https://140706.selcdn.ru/lastangel/media/pets/".$_row['id']."/video2.mp4", 'r')
			);
	}
			if ($_row['video3']) {
			file_put_contents(
				"media/pets/".$_row['id']."/video3.mp4", 
				fopen("https://140706.selcdn.ru/lastangel/media/pets/".$_row['id']."/video3.mp4", 'r')
			);
	}
			file_put_contents(
				"media/pets/".$_row['id']."/main.jpeg", 
				fopen("https://140706.selcdn.ru/lastangel/media/pets/".$_row['id']."/main.jpeg", 'r')
			);
			//file_put_contents(
	...
	if (count($another_images) > 0) {
		foreach ($another_images as $another_image) {
			file_put_contents(
				"media/pets/".$_row['id']."/another_".$another_image.".jpeg", 
				fopen("https://140706.selcdn.ru/lastangel/media/pets/".$_row['id']."/another_".$another_image.".jpeg", 'r')
			);
			//file_put_contents(
...
$_stmt = $db_mysqli->prepare("SELECT id, another_images, main_image, video1, video2, video3 from collections");
...
while($_row = $_result->fetch_array()){
	...
	if ($_row['video1']) {
			file_put_contents(
				...
				fopen("https://140706.selcdn.ru/lastangel/media/collections/".$_row['id']."/video1.mp4", 'r')
			);
	}
		if ($_row['video2']) {
			file_put_contents(
				"media/collections/".$_row['id']."/video2.mp4", 
				fopen("https://140706.selcdn.ru/lastangel/media/collections/".$_row['id']."/video2.mp4", 'r')
			);
	}
			if ($_row['video3']) {
			file_put_contents(
				"media/collections/".$_row['id']."/video3.mp4", 
				fopen("https://140706.selcdn.ru/lastangel/media/collections/".$_row['id']."/video3.mp4", 'r')
			);
	}
			file_put_contents(
				"media/collections/".$_row['id']."/main.jpeg", 
				fopen("https://140706.selcdn.ru/lastangel/media/collections/".$_row['id']."/main.jpeg", 'r')
			);
			//file_put_contents(
	...
	if (count($another_images) > 0) {
		foreach ($another_images as $another_image) {
			file_put_contents(
				"media/collections/".$_row['id']."/another_".$another_image.".jpeg", 
				fopen("https://140706.selcdn.ru/lastangel/media/collections/".$_row['id']."/another_".$another_image.".jpeg", 'r')
			);
			//file_put_contents(
	...
	if (count($another_images) > 0) {
		foreach ($another_images as $another_image) {
			file_put_contents(
				...
				fopen("https://140706.selcdn.ru/lastangel/media/mainphotoalbum/another_".$another_image.".jpeg", 'r')
			);
			//file_put_contents(
	...
	if (count($another_images) > 0) {
		foreach ($another_images as $another_image) {
			file_put_contents(
				...
				fopen("https://140706.selcdn.ru/lastangel/media/documents/another_".$another_image.".jpeg", 'r')
			);
			//file_put_contents(
	...
	if (count($another_images) > 0) {
		foreach ($another_images as $another_image) {
			file_put_contents(
				...
				fopen("https://140706.selcdn.ru/lastangel/media/clinicPhotos/another_".$another_image.".jpeg", 'r')
			);
			//file_put_contents(
			//	"media/collections/".$_row['id']."/another_".$another_image."_1.jpeg", 
...
$_stmt = $db_mysqli->prepare("SELECT id, another_images, video1, video2, video3 from news");
...
while($_row = $_result->fetch_array()){
	...
	if ($_row['video1']) {
			file_put_contents(
				...
				fopen("https://140706.selcdn.ru/lastangel/media/news/".$_row['id']."/video1.mp4", 'r')
			);
	}
		if ($_row['video2']) {
			file_put_contents(
				"media/news/".$_row['id']."/video2.mp4", 
				fopen("https://140706.selcdn.ru/lastangel/media/news/".$_row['id']."/video2.mp4", 'r')
			);
	}
			if ($_row['video3']) {
			file_put_contents(
				"media/news/".$_row['id']."/video3.mp4", 
				fopen("https://140706.selcdn.ru/lastangel/media/news/".$_row['id']."/video3.mp4", 'r')
			);
	}
	...
	if (count($another_images) > 0) {
		foreach ($another_images as $another_image) {
			file_put_contents(
				"media/news/".$_row['id']."/another_".$another_image.".jpeg", 
				fopen("https://140706.selcdn.ru/lastangel/media/news/".$_row['id']."/another_".$another_image.".jpeg", 'r')
			);
			//file_put_contents(
...
$_stmt = $db_mysqli->prepare("SELECT id, another_images, video1, video2, video3 from stories");
...
while($_row = $_result->fetch_array()){
	...
	if ($_row['video1']) {
			file_put_contents(
				...
				fopen("https://140706.selcdn.ru/lastangel/media/stories/".$_row['id']."/video1.mp4", 'r')
			);
	}
		if ($_row['video2']) {
			file_put_contents(
				"media/stories/".$_row['id']."/video2.mp4", 
				fopen("https://140706.selcdn.ru/lastangel/media/stories/".$_row['id']."/video2.mp4", 'r')
			);
	}
			if ($_row['video3']) {
			file_put_contents(
				"media/stories/".$_row['id']."/video3.mp4", 
				fopen("https://140706.selcdn.ru/lastangel/media/stories/".$_row['id']."/video3.mp4", 'r')
			);
	}
	...
	if (count($another_images) > 0) {
		foreach ($another_images as $another_image) {
			file_put_contents(
				"media/stories/".$_row['id']."/another_".$another_image.".jpeg", 
				fopen("https://140706.selcdn.ru/lastangel/media/stories/".$_row['id']."/another_".$another_image.".jpeg", 'r')
			);
			//file_put_contents(
