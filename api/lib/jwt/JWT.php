        ...
        switch ($function) {
            ...
            case 'sodium_crypto':
                if (!\function_exists('sodium_crypto_sign_detached')) {
                    throw new Exception('libsodium is not available');
                }
                if (!\is_string($key)) {
                    throw new Exception('key must be a string when using EdDSA');
                }
                try {
            ...
            case 'sodium_crypto':
                ...
                try {
                    ...
                    if (\strlen($signature) === 0) {
                        throw new Exception('Signature cannot be empty string');
                    }
